/**
 * @license
 * Copyright 2020 edx.so
 * SPDX-License-Identifier: Apache-2.0
 */

/**
 * @fileoverview JavaScript for Database Blockly's demo.
 * @author beign.he@gmail.com (HETJ)
 */
...
/**
 * 检查剩余块数量Check remaining
 * @param {*} event 
 */
function onchange(event) {
    document.getElementById('capacity').textContent =
    Code.workspace.remainingCapacity();
}
...
Code.initLanguage = function() {    
  ...
  var comp = function(a, b) {
    // Sort based on first argument ('English', '袪褍褋褋泻懈泄', '绠€浣撳瓧', etc).
    if (a[0] > b[0]) return 1;
    if (a[0] < b[0]) return -1;
    return 0;
  };
